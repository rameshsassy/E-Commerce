...
const COPY = {
  ...
  multiple_categories: {
    title: 'Upgrade to use more categories',
    body: 'Free plan includes one main category for your catalog. Upgrade to Premium for sub-categories, product types, and multiple categories.',
  },
  premium: {
    title: 'Upgrade to Premium',
    body: 'Unlock multiple categories, stores, extra addresses, bulk orders, B2B inquiries, and more seller tools.',
  },
};

export default function UpgradePremiumModal({ open, onClose, feature = 'premium' }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-[14px] text-[#6D7175] leading-relaxed mb-6">{copy.body}</p>
