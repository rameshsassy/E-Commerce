...
import { getOtherPortalRegisterUrl, resolveSellerPortalOrigin } from '../../utils/portalHost';
...
export default function Footer() {
  ...
  const sellerPortalOrigin = resolveSellerPortalOrigin();
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-12">
        ...
        <div className="lg:col-span-3 flex flex-col gap-4">
          ...
          <ul className="space-y-2.5 text-sm text-text-muted font-medium list-disc pl-4">
            ...
            <li>
              <a href={`${sellerPortalOrigin}/seller/refer-and-earn`} className="hover:text-white transition-colors">Refer & Earn</a>
            </li>
            <li>
