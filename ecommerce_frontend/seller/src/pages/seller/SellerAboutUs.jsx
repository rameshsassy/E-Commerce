...
export default function SellerAboutUs() {
  return (
    <div className="w-full animate-fade-in">
      <style>{`
        @keyframes sab-scroll-left {
          0% { transform: translateX(0); }
          100% { transform: translateX(-50%); }
        }
        @keyframes sab-scroll-right {
          0% { transform: translateX(-50%); }
          100% { transform: translateX(0); }
        }
        @keyframes sab-kenburns {
          0% { transform: scale(1); }
          100% { transform: scale(1.08); }
        }
        @keyframes sab-fadeinup {
          from { opacity: 0; transform: translateY(24px); }
          to { opacity: 1; transform: translateY(0); }
        }
        .sab-scroll-left { animation: sab-scroll-left 40s linear infinite; }
        .sab-scroll-right { animation: sab-scroll-right 40s linear infinite; }
        .sab-scroll-mask {
        ...
        .sab-kenburns { animation: sab-kenburns 12s ease-in-out infinite alternate; }
        .sab-fadein { animation: sab-fadeinup 0.7s ease-out forwards; }
        .sab-fadein-d { opacity: 0; animation: sab-fadeinup 0.7s ease-out 0.25s forwards; }
      `}</style>
      ...
      <section className="relative overflow-hidden rounded-3xl min-h-[420px] md:min-h-[480px] flex items-center mb-8">
        <div className="absolute inset-0 rounded-3xl overflow-hidden">
          <img
            ...
            alt="Aashansh About"
            className="w-full h-full object-cover sab-kenburns"
          />
        ...
        <div className="relative w-full px-8 md:px-14 py-16">
          <span className="inline-flex items-center gap-1.5 text-white/90 text-xs font-bold mb-4 tracking-[0.2em] uppercase bg-white/10 backdrop-blur-sm px-5 py-2 rounded-full border border-white/15 sab-fadein">
            <Sparkles size={12} /> About Aashansh
          </span>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-white mb-5 tracking-tight leading-[1.08] sab-fadein-d">
            Empowering Communities Through Conscious Commerce
          </h1>
          <p className="text-base text-white/75 max-w-xl font-medium leading-relaxed sab-fadein-d">
          ...
          <div className="flex flex-wrap gap-3 mt-7 sab-fadein-d">
            <Link
            ...
            >
              Grow with Aashansh <ArrowRight size={16} />
            </Link>
          </div>
        </div>
      </section>
      ...
      <div className="relative mb-8">
        ...
        <div className="relative glass-panel rounded-3xl p-8 md:p-12 border border-glass-border text-center overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="sab-scroll-mask overflow-hidden">
              <div className="w-max flex gap-3 sab-scroll-left">
        ...
        <div className="relative rounded-3xl overflow-hidden shadow-xl">
          ...
          <div className="relative p-10 md:p-14 text-center text-white">
            ...
            <p className="text-base text-white/85 font-medium mb-7 max-w-xl mx-auto">
              Join thousands of sellers on Aashansh and be part of India's movement toward conscious, inclusive, and impactful commerce.
            </p>
            <Link
              to="/seller/subscription"
            ...
            >
              Upgrade Your Plan <ArrowRight size={18} />
            </Link>
          </div>
        </div>
      </div>
        ...
        <div className="relative grid md:grid-cols-2 gap-6 items-center p-8 md:p-12">
          <div>
            ...
            <p className="text-sm font-semibold text-text-muted mb-5 max-w-md">
              Ask us anything. Didn&apos;t find what you were looking for? Sign up to connect with our team.
            </p>
