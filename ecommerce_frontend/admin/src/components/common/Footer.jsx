    ...
    <footer className="bg-slate-950 border-t border-glass-border pt-12 pb-8 px-4 sm:px-6 lg:px-8 mt-auto w-full text-white">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-12">
        ...
        <div className="lg:col-span-3 flex flex-col gap-4">
          ...
          <ul className="space-y-2.5 text-sm text-text-muted font-medium list-disc pl-4">
            <li>
              <a href={`${customerPortalOrigin}/refund-policy`} className="hover:text-white transition-colors">Refund policy</a>
            </li>
            <li>
              <a href={`${customerPortalOrigin}/return-policy`} className="hover:text-white transition-colors">Return Policy</a>
            </li>
            <li>
              <a href={`${customerPortalOrigin}/replacement-policy`} className="hover:text-white transition-colors">Replacement Policy</a>
            </li>
            <li>
              <a href={`${customerPortalOrigin}/terms`} className="hover:text-white transition-colors">Terms of Use</a>
            </li>
            <li>
              <a href={`${customerPortalOrigin}/shipping-policy`} className="hover:text-white transition-colors">Shipping Policy</a>
            </li>
            <li>
              <a href={`${customerPortalOrigin}/seller-agreement`} className="hover:text-white transition-colors">Seller Agreement</a>
            </li>
          </ul>
        </div>
      </div>
